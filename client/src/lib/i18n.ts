export const translations = {
  en: {
    ...
    consentText: "By checking this box, you acknowledge that you have read our Data Protection Notice. We are committed to protecting your privacy and will never sell your data.",
  ...
  fr: {
    ...
    consentText: "En cochant cette case, vous reconnaissez avoir lu notre Avis de Protection des Données. Nous nous engageons à protéger votre vie privée et ne vendrons jamais vos données.",
